...
老師管理權限綁定各裝置的匿名瀏覽器身分。已授權的老師端可產生 10 分鐘有效、限一台新裝置使用的「跨裝置監看」連結；新裝置註冊後與同一課堂的其他老師裝置享有相同完整權限，每個課堂最多五台老師裝置。如果所有已授權裝置都清除網站資料，仍無法自動找回課堂。只應輸入座號或暱稱，不應輸入身分證字號、電話、Email、住址或醫療資料。
